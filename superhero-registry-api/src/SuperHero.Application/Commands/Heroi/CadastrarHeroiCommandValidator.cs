...
public class CadastrarHeroiCommandValidator : AbstractValidator<CadastrarHeroiCommand>
{
    private readonly IRepository<SuperHeroDbContext> _repository;
    public CadastrarHeroiCommandValidator(IRepository<SuperHeroDbContext> repository)
    {
